...
Training data was chosen to keep the vehicle driving on the road. I used a combination of center lane driving, recovering from the left and right sides of the road as well flipped images from the center camera. 
...
The overall strategy for deriving a model architecture was to start with a proven architecture
